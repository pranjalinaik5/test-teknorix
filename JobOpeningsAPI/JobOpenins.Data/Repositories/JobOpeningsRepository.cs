...
namespace JobOpenins.Data.Repositories
{
    public class JobOpeningsRepository : IJobOpenings
    {
        public async Task<bool> InsertJobs(JobModel lstJobs)
        {
            ...
            SqlCommand sqlcomm = new SqlCommand("dbo.USP_INS_UPD_WORKS");
            sqlconn.Open();
        ...
        {
            SqlConnection sqlconn = new SqlConnection("Data Source=#;Initial Catalog=#;User ID=#;Password=#");
            SqlCommand sqlcomm = new SqlCommand("dbo.USP_GET_WORK_LIST");
            sqlconn.Open();
            sqlcomm.Connection = sqlconn;
            sqlcomm.CommandType = CommandType.StoredProcedure;
            ...
            while (sdr.Read())
            {
                JobDtls.Job_Id = sdr["WORK_ID"].ToString();
        ...
        {
            SqlConnection sqlconn = new SqlConnection("Data Source=#;Initial Catalog=#;User ID=#;Password=#");
            SqlCommand sqlcomm = new SqlCommand("dbo.USP_GET_WORK_DTLS");
            sqlconn.Open();
            sqlcomm.Connection = sqlconn;
            sqlcomm.CommandType = CommandType.StoredProcedure;
            sqlcomm.Parameters.AddWithValue("@WORKId", id);
